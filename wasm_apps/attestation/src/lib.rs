...
pub extern fn main(module_hash_size:usize, runtime_args_size:usize, runtime_result_size:usize, memory_args_size:usize, memory_result_size:usize) -> (i32,i32) {
    let zero:u32 = 0;
    let module_hash = unsafe { slice::from_raw_parts(&zero, module_hash_size) };
    let runtime_args_ptr = module_hash_size;
    ...
    let runtime_args_hash_ptr = memory_result_prt + memory_result_size;
